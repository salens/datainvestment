...
<div class="wrap about-wrap agni-welcome-page-wrap">
    ...
    <?php if( $active_tab == 'welcome' ) { ?>
        <div id="welcome" class="agni-welcome">
        	<h3><?php esc_html_e( '1 - Install & Activate Required Plugins', 'fortun' ); ?></h3>
        	...
        	<h3><?php esc_html_e( '2 - Import Demo Contents', 'fortun' ); ?></h3>
        	...
        	<h3><?php esc_html_e( '3 - Customize at Option Panel', 'fortun' ); ?></h3>
